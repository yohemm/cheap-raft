from objects.menu import Menu_upgrade, MenuCreateBuild
from objects.raft import Raft
from objects.waste import Waste
import pygame
import random
import time
...
menuBuilding = MenuCreateBuild((SCREEN_SIZE[0] //7 * 6, int(SCREEN_SIZE[1]//6* 0.5)), (SCREEN_SIZE[0] //7, int(SCREEN_SIZE[1]*0.75)), (50,50,50,128), bats)
